...
def solve(grids, par, iNj, mMarkov,vCoeff_C,vCoeff_NC, sceptics=True, welfare=True):
    ...
    g_index_indiff=int((grids.vG.size-1)/2)
    assert grids.vG[g_index_indiff]==1
        ...
        for t_index in range(grids.vTime.size-1, -1, -1):        
            ...
            for j in range(iNj-1, -1, -1):
                if j == iNj-1:
                    ...
                    w_c_vE,q_c_vE, w_c_wf_vE = continuation_value_epsilons.solve_owners_C(par, grids,  j+1, k_index, mMarkov, dPi_S, dPi_L, coastal_stayer_inputs,mover_inputs,dP_C_prime, mortgage_size_C, welfare)
                ...
                for e_index in range(grids.vE.size): 
                    ...
                    vt_stay_nc[t_index,j, k_index,g_index,:,:,:,e_index], c_nc[t_index,j, k_index,g_index,:,:,:,e_index],  qt_stay_nc[t_index,j, k_index,g_index,:,:,:,e_index], b_stay_nc[t_index,j, k_index,g_index,:,:,:,e_index], vt_stay_nc_wf[t_index,j, k_index,g_index,:,:,:,e_index] = stayer_problem.solve(par, grids, j, k_index, g_index_indiff, w_nc,q_nc, w_nc_wf, welfare)
                    ...
                    vt_buy_nc[t_index,j, k_index,g_index,:,e_index], qt_buy_nc[t_index,j, k_index,g_index,:,e_index], vt_buy_nc_wf[t_index,j, k_index,g_index,:,e_index] = buyer_problem_epsilons.solve(par, grids, j, k_index, g_index_indiff, e_index, dP_NC, vt_stay_nc[t_index,j, k_index,g_index,:,:,:,e_index], c_nc[t_index,j, k_index,g_index,:,:,:,e_index], vt_stay_nc_wf[t_index,j, k_index,g_index,:,:,:,e_index], welfare)
        ...
        for g_index in range(grids.vG.size):
            ...
            for j in range(iNj-1, -1, -1):
                ...
                for e_index in range(grids.vE.size): 
                    ...
                    vt_stay_nc[0,j, k_index,g_index,:,:,:,e_index], c_nc[0,j, k_index,g_index,:,:,:,e_index],  qt_stay_nc[0,j, k_index,g_index,:,:,:,e_index], b_stay_nc[0,j, k_index,g_index,:,:,:,e_index], vt_stay_nc_wf[0,j, k_index,g_index,:,:,:,e_index] = stayer_problem.solve(par, grids, j, k_index, g_index_indiff, w_nc,q_nc, w_nc_wf, welfare)
                    ...
                    vt_buy_nc[0,j, k_index,g_index,:,e_index], qt_buy_nc[0,j, k_index,g_index,:,e_index], vt_buy_nc_wf[0,j, k_index,g_index,:,e_index] = buyer_problem_epsilons.solve(par, grids, j, k_index, g_index_indiff, e_index, dP_NC, vt_stay_nc[0,j, k_index,g_index,:,:,:,e_index], c_nc[0,j, k_index,g_index,:,:,:,e_index], vt_stay_nc_wf[0,j, k_index,g_index,:,:,:,e_index], welfare)
