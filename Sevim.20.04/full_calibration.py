...
def f(x,grad):
    ...
    par_dict = {"time_increment": time_increment,
              ...
              "r_m_c": 1.04**time_increment - 1,
              "r_m_c_experiment": 1.06**time_increment - 1,
              "r_m_nc": 1.04**time_increment - 1,
              "wf_wedge": np.array([0.]),
              "dKappa_sell": 0.07,
              "dKappa_buy": 0,
              "dXi_foreclosure": 0.8,
              ...
              'dL': 0.311,
              'dOmega': dOmega,
              'dMitigation_rate': 0.55,
              'building_rest_cost': 0.14,
    ...
    initial = True
    sceptics = False
    dP_C_guess, dP_NC_guess, vCoeff_C_new, vCoeff_NC_new, mDist1_c, mDist1_nc, mDist1_renter, rental_stock_C, rental_stock_NC, coastal_beq, noncoastal_beq, savings_beq, no_beq, iteration=equil.initialise_coefficients_ss(par, grids, method, par.iNj, mMarkov, vCoeff_C_initial, vCoeff_NC_initial)      
    vt_stay_c, vt_stay_nc, vt_renter, b_stay_c, b_stay_nc, b_renter = household_problem.solve_ss(grids, par, par.iNj, mMarkov, vCoeff_C_new[0],vCoeff_NC_new[0], True, sceptics, False)
    mDist1_c, mDist1_nc, mDist1_renter, rental_stock_C, rental_stock_NC, coastal_beq, noncoastal_beq, savings_beq, vcoastal_beq, vnoncoastal_beq, vsavings_beq, no_beq, coastal_mass_J, noncoastal_mass_J, renter_mass_J=sim.stat_dist_finder(sceptics, grids, par, mMarkov, par.iNj, vt_stay_c[0,], vt_stay_nc[0,], vt_renter[0,], b_stay_c[0,], b_stay_nc[0,], b_renter[0,], vCoeff_C_new,vCoeff_NC_new, np.zeros((3)), initial)
