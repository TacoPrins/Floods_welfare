...
def full_information_experiment(par, func, method,  vCoeff_C, vCoeff_NC, vCoeff_C_experiment_guess, vCoeff_NC_experiment_guess, vCoeff_C_initial, vCoeff_NC_initial):
