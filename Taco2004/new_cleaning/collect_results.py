...
@njit
def collect_results(par, grids, vCoeff_C_initial, vCoeff_NC_initial, vCoeff_C, vCoeff_NC, vCoeff_C_RE, vCoeff_NC_RE, vCoeff_C_FullInfo, vCoeff_NC_FullInfo, vCoeff_C_MortPrem, vCoeff_NC_MortPrem, vCoeff_C_BuildRest, vCoeff_NC_BuildRest):
    ...
    solve_initial_ss = True
    sceptics = True
    bequest_guess=np.zeros((3))

    vt_stay_c_ss, vt_stay_nc_ss, vt_renter_ss, b_stay_c_ss, b_stay_nc_ss, b_renter_ss = household_problem.solve_ss(grids, par, vCoeff_C_initial[0],vCoeff_NC_initial[0], solve_initial_ss, sceptics)
    mDist1_c_ss, mDist1_nc_ss, mDist1_renter_ss, rental_stock_C_ss, rental_stock_NC_ss, coastal_beq_ss, noncoastal_beq_ss, savings_beq_ss, _, _, _, no_beq, coastal_mass_J, noncoastal_mass_J, renter_mass_J = sim.stat_dist_finder(sceptics, grids, par, vt_stay_c_ss[0,], vt_stay_nc_ss[0,], vt_renter_ss[0,], b_stay_c_ss[0,], b_stay_nc_ss[0,], b_renter_ss[0,], vCoeff_C_initial,vCoeff_NC_initial, bequest_guess, solve_initial_ss)
