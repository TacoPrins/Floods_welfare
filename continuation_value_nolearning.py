...
@njit
def solve_last_period_owners_C(par, grids,  vPi_S, k_index, dP_C_prime,mortgage_size_C, welfare):
            ...
            for l_index in range(grids.vL.size):
                ...
                for damage_index in range(grids.vZ.size):
                    ...
                    if k_index==0:
                        ...
                        if damage_index==0:
                            prob_dZ=(1-par.dPi_S_initial)
                            prob_dZ_true = (1-vPi_S)
                        else:                                    
                            prob_dZ = par.dPi_S_initial*grids.vPDF_z[damage_index] 
...
@njit
def solve_owners_C(par, grids, j_index, k_index, mMarkov, vPi_S, coastal_stayer_inputs,coastal_mover_inputs, dP_C_prime,mortgage_size_C, welfare):
